...
import { TimeSeriesChart, TOOLTIP_STYLE } from "@/components/noc/TimeSeriesChart";
            ...
            {WINDOWS.map(w => (
              <button
                ...
                className={cn(
                  ...
                  days === w ? "bg-accent/20 text-accent" : "text-white/50 hover:text-white/80"
                )}
                aria-pressed={days === w}
              >
                {w}d
          ...
          <div className="mt-4">
            {rel.isLoading && !r ? (
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="text-left text-white/40 uppercase tracking-wider text-[10px]">
                ...
                <tbody>
                  {r.byTarget.map(t => (
                    <tr key={`${t.targetType}:${t.targetKey}`} className="border-t border-white/5">
                      ...
                      <td className="py-2 text-white/50">{t.targetType}</td>
                      <td className="py-2">
                        <RagBadge
          ...
          <div className="mt-4">
            {hist.isLoading && !hist.data ? (
              ...
              <TimeSeriesChart
                data={histData}
                series={[
                  { key: "cpu", label: "CPU %", color: "hsl(191 87% 53%)" },
                  { key: "mem", label: "RAM %", color: "hsl(248 92% 70%)" }
                ]}
                xKey="t"
                height={260}
