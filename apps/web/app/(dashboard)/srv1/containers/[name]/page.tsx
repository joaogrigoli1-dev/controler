    ...
    <div className="space-y-6 animate-fade-up">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0">
          <Link href="/srv1/containers" className="text-xs text-white/40 hover:text-white/70 flex items-center gap-1 mb-1.5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="glass-card p-5">
            ...
            <TimeSeriesChart
              ...
              unit="%"
              series={[{ key: "cpu", label: "CPU %", color: "hsl(191 87% 53%)" }]}
            />
          </div>
          ...
          <div className="glass-card p-5">
            ...
            <TimeSeriesChart
              ...
              legend
              series={[
                { key: "mem", label: "Memória MB", color: "hsl(248 92% 70%)" },
                { key: "trend", label: "tendência 6h", color: "hsl(45 95% 53%)", dashed: true }
              ]}
            />
          </div>
          ...
          {hasNet && (
            <div className="glass-card p-5">
              ...
              <TimeSeriesChart
                ...
                legend
                series={[
                  { key: "rx", label: "RX Kbps", color: "hsl(160 70% 45%)" },
                  { key: "tx", label: "TX Kbps", color: "hsl(191 87% 53%)" }
                ]}
              />
            </div>
          )}
          ...
          {hasBlkio && (
            <div className="glass-card p-5">
              ...
              <TimeSeriesChart
                ...
                legend
                series={[
                  { key: "br", label: "read Kbps", color: "hsl(280 70% 65%)" },
                  { key: "bw", label: "write Kbps", color: "hsl(45 95% 53%)" }
                ]}
              />
            </div>
          )}
