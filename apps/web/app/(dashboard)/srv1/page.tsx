...
import { TimeSeriesChart } from "@/components/noc/TimeSeriesChart";
  ...
  return (
    <div className="rounded-md border border-white/5 bg-white/[0.02] p-4">
      ...
      <div className="text-3xl font-bold text-mono">
        ...
        <span className="text-[10px] text-white/40 font-normal ml-2">{refLabel}</span>
      </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div className="rounded-md border border-white/5 bg-white/[0.02] p-4 flex items-center justify-between">
                <div>
                  <div className="text-[10px] uppercase tracking-widest text-white/40 mb-1">Swap</div>
                  <div className="text-xl font-bold text-mono">
                    {swap ? `${fmtNum(swap.usedMb, 0)} / ${fmtNum(swap.totalMb, 0)} MB` : "—"}
                    {swapPct != null && <span className="text-[10px] text-white/40 font-normal ml-2">{fmtNum(swapPct)}%</span>}
                  </div>
                  <div className="text-xs text-white/50 text-mono mt-1">
              ...
              <div className="rounded-md border border-white/5 bg-white/[0.02] p-4 flex items-center justify-between">
                <div>
                  <div className="text-[10px] uppercase tracking-widest text-white/40 mb-1">Load por core</div>
                  <div className="text-xl font-bold text-mono">
                    {loadPerCore != null ? fmtNum(loadPerCore, 2) : "—"}
                    <span className="text-[10px] text-white/40 font-normal ml-2">{nproc ?? "—"} vCPU</span>
                  </div>
                  <div className="text-xs text-white/50 text-mono mt-1">
